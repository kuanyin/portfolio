...
;(function() {
    ...
    this.ScrollReveal = (function() {
        ...
        ScrollReveal.prototype.defaults = {
            ...
            //            callbacks, remember they are passed the element�䏭 DOM node that triggered
        ...
        ScrollReveal.prototype.reveal = function(selector, config, interval, sync) {
            ...
            // Let�䏭 check to see if a DOM node was passed in as the first argument,
            ...
            // let�䏭 shuffle things around to make sure everything works.
            ...
            for (var i = 0; i < elements.length; i++) {
                ...
                // Otherwise, let�䏭 do some basic setup.
                else {
                    elem = {
                        id        : _nextUid(),
                        domEl     : elements[i],
                ...
                // New or existing element, it�䏭 time to update its configuration, styles,
            ...
            // Since `reveal()` is called internally by `sync()`, we don�脌 want to
        ...
        function _configure(elem, config) {
            ...
            // If the element hasn�脌 already been configured, let�䏭 use a clone of the
            // defaults extended by the configuration passed as the second argument.
            if (!elem.config) {
                elem.config = sr.tools.extendClone(sr.defaults, config);
            }

            // Otherwise, let�䏭 use a clone of the existing element configuration extended
        ...
        function _updateStore(elem) {
            ...
            // If this element�䏭 container isn�脌 already in the store, let�䏭 add it.
        ...
        function _init() {
            if (sr.isSupported()) {
                ...
                // Let�䏭 also do a one-time binding of window event listeners.
                if (!sr.initialized) {
        ...
        function _setActiveSequences() {
            ...
            sr.tools.forOwn(sr.sequences, function(sequenceId) {
                ...
                // For each sequenced elemenet, let�䏭 check visibility and if
                // any are visible, set it�䏭 sequence to active.
        ...
        function _animate() {
            ...
            sr.tools.forOwn(sr.store.elements, function(elemId) {
                ...
                // Let�䏭 see if we should reveal, and if so, whether to use delay.
                if (_shouldReveal(elem)) {
                    ...
                    // Let�䏭 queue the `afterReveal` callback and tag the element.
                ...
                // If we got this far our element shouldn�脌 reveal, but should it reset?
        ...
        function _queueNextInSequence(elem, delayed) {
            ...
            // We�胩e processing a sequenced element, so let's block other elements in this sequence.
            sequence.blocked = true;

            // Since we�胩e triggering animations a part of a sequence after animations on first load,
        ...
        function _queueCallback(type, elem, delayed) {
            ...
            // Check which callback we�胩e working with.
            switch (type) {
            ...
            elem.timer.clock = window.setTimeout(function() {
                ...
                // The timer completed, so let�䏭 fire the callback and null the timer.
        ...
        function _getScrolled(container) {
            ...
            // Otherwise, default to the window object�䏭 scroll values.
            else {
                return {
        ...
        function _getOffset(domEl) {
            ...
            var
                ...
                // Grab the element�䏭 dimensions.
                offsetHeight = domEl.offsetHeight,
                offsetWidth  = domEl.offsetWidth;

            // Now calculate the distance between the element and its parent, then
            // again for the parent to its parent, and again etc... until we have the
            // total distance of the element to the document�䏭 top and left origin.
            do {
        ...
        function _isElemVisible(elem) {
            ...
            function confirmBounds() {
                ...
                var
                    // Define the element�䏭 functional boundaries using its view factor.
